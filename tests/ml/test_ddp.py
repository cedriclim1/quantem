...
def test_cuda_kernel_gate_disables_initialized_multirank_process_group(monkeypatch):
...
def test_cuda_kernel_gate_allows_initialized_single_rank_process_group(monkeypatch):
    from quantem.core import config
